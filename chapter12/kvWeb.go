// The commands for these four functions will be named ADD, DELETE, LOOKUP, and CHANGE, respectively.
// This means that the program will only operate when its gets one of these four commands.
// Additionally, the program will stop when you enter the STOP word as input, and it will
// print the full contents of the key-value store when you enter the PRINT command.
